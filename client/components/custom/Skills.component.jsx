    ...
    return (
        <div className='relative z-10 max-w-5xl mx-auto px-8 mb-36'>
            ...
            <div className='w-full h-full absolute top-80 right-8 flex justify-start -z-10'>
                <div className='w-[300px] h-[300px] sm:w-[600px] sm:h-[600px] bg-gradient-to-t from-cyan-400 to-cyan-300 rounded-full blur-[80px] sm:animate-sixth sm:blur-[240px] overflow-x-hidden'></div>
            </div>
